...
export default class CenaCliente2 extends Component {
  _isMounted = false;
  constructor(props) {
    super(props);
    /* menu */
    ...
    if (
      ...
      try {
        ...
        [
          ...
          this.props.navigation.getParam('idapp')
        ]
        );
        /*this.props.navigation.getParam('idapp')*/
        if(results[0].insertId) {
            ...
            Alert.alert(
              ...
              "Clique 'SIM' para adicionar mais fazendas, ou clique 'NÃO' para prosseguir...",
              [
                {
                  text: "NÃO",
                  onPress: () => this.props.navigation.navigate('cliente3', { 
                    idapp : this.props.navigation.getParam('idapp'),
                  }),
                  style: "cancel"
                },
                {
                  text: "SIM",
                  onPress: () => this.props.navigation.push('cliente2', {
                    idapp : this.props.navigation.getParam('idapp')}),
                }
              ]
            );
    ...
    return (
      ...
      >
        <View style={styles.container}>
          ...
          />
          <ScrollView>
            <Text style={styles.txtTitulo}>CADASTRO DE FAZENDA</Text> 
